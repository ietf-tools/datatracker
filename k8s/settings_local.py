...
if _bibxml_bucket_name == "":
    raise RuntimeError("DATATRACKER_BLOB_STORE_BIBXML_BUCKET_NAME must be set")
...
STORAGES["bibxml_bucket"] = {
    ...
    "OPTIONS": dict(
        ...
        verify=False,
        bucket_name=_bibxml_bucket_name,
    ),
}
BIBXML_DELETE_THEN_WRITE = False  # S3Storage allows file_overwrite by default
BIBXML_OUTPUT_PATH = os.environ.get("DATATRACKER_BIBXML_OUTPUT_PATH", "bibxml/")
