...
setup(
    ...
    version=idnits.__version__,

    description="Convert text-format RFCs and Internet-Drafts to .xml format",
    long_description=long_description,

    # The project's main homepage.
    url='https://tools.ietf.org/tools/ietfdb/browser/branch/elft/idnits/',
...
#    data_files=[('/usr/local/share/man/man1', ['idnits/idnits.1.gz',])],
