...
urlpatterns = patterns('sec.sessions.views',
    ...
    #url(r'^(?P<session_id>\d{1,6})/approve/$', 'approve', name='sessions_approve'),
    #url(r'^(?P<session_id>\d{1,6})/cancel/$', 'cancel', name='sessions_cancel'),
    #url(r'^(?P<session_id>\d{1,6})/edit/$', 'edit', name='sessions_edit'),
