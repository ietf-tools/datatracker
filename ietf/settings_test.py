...
TEMPLATES[0]["OPTIONS"]["context_processors"] = [  # pyflakes:ignore
    p
    for p in TEMPLATES[0]["OPTIONS"]["context_processors"]  # pyflakes:ignore
    if not p in DEV_TEMPLATE_CONTEXT_PROCESSORS  # pyflakes:ignore
]
