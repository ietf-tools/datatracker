...
if (
    TEST_CODE_COVERAGE_CHECKER and not TEST_CODE_COVERAGE_CHECKER._started
):  # pyflakes:ignore
...
TEMPLATES[0]["OPTIONS"]["context_processors"] = [
    ...
    if not p in DEV_TEMPLATE_CONTEXT_PROCESSORS
]  # pyflakes:ignore
...
_blob_store_endpoint_url = os.environ.get(
    "DATATRACKER_BLOB_STORE_ENDPOINT_URL", "http://blobstore:9000"
)
_blob_store_access_key = os.environ.get(
    "DATATRACKER_BLOB_STORE_ACCESS_KEY", "minio_root"
)
_blob_store_secret_key = os.environ.get(
    "DATATRACKER_BLOB_STORE_SECRET_KEY", "minio_pass"
)
_blob_store_bucket_prefix = os.environ.get(
    "DATATRACKER_BLOB_STORE_BUCKET_PREFIX", "test-"
)
