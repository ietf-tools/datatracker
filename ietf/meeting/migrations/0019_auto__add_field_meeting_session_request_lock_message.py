...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meeting.session_request_lock_message'
        db.add_column(u'meeting_meeting', 'session_request_lock_message',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Meeting.session_request_lock_message'
        db.delete_column(u'meeting_meeting', 'session_request_lock_message')
    ...
    models = {
        ...
        u'meeting.meeting': {
            ...
            'session_request_lock_message': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
