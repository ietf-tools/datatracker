    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.DurationField(
                        blank=True,
                        default=datetime.timedelta(seconds=86399),
                ...
                (
                    "submission_correction_day_offset",
                    models.IntegerField(
                        blank=True,
                        default=50,
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Are the proceedings for this meeting complete?",
                    ),
                ),
                (
                    "acknowledgements",
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        limit_choices_to={"is_group_conflict": True},
                        to="name.ConstraintName",
                    ),
                ),
                (
                    "overview",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "resources",
                    models.ManyToManyField(
                        blank=True, to="meeting.ResourceAssociation"
                    ),
                ),
                (
                    "session_types",
                    models.ManyToManyField(blank=True, to="name.TimeSlotTypeName"),
                ),
            ],
            options={
                "ordering": ["-id"],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Do not move session during automatic placement.",
                    ),
                ),
                (
                    "extendedfrom",
                    ietf.utils.models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        to="meeting.SchedTimeSessAssignment",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Is this session visible on the meeting agenda?",
                    ),
                ),
                (
                    "group",
                ...
                (
                    "joint_with_groups",
                    models.ManyToManyField(
                        blank=True, related_name="sessions_joint_in", to="group.Group"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "room",
                    ietf.utils.models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="meeting.Room"
                    ),
                ),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    ietf.utils.models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        to="name.SlideSubmissionStatusName",
                    ),
                ),
                (
                    "submitter",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, through="meeting.SessionPresentation", to="doc.Document"
            ),
        ),
        migrations.AddField(
            model_name="session",
            ...
            field=ietf.utils.models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="meeting.Meeting"
            ),
        ),
        migrations.AddField(
            model_name="session",
            name="purpose",
            field=ietf.utils.models.ForeignKey(
                help_text="Purpose of the session",
                on_delete=django.db.models.deletion.CASCADE,
                to="name.SessionPurposeName",
            ),
        ),
        migrations.AddField(
            model_name="session",
        ...
        migrations.AddField(
            ...
            name="type",
            field=ietf.utils.models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="name.TimeSlotTypeName"
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        verbose_name="Show in agenda list",
                    ),
                ),
                (
                    "public",
        ...
        migrations.AddField(
            ...
            field=ietf.utils.models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="sessionassignments",
                to="meeting.TimeSlot",
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "document",
                    ietf.utils.models.ForeignKey(
                        limit_choices_to={"type_id": "procmaterials"},
                        on_delete=django.db.models.deletion.CASCADE,
                        to="doc.Document",
                        unique=True,
                    ),
                ...
                (
                    ...
                    ietf.utils.models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="proceedings_materials",
                        to="meeting.Meeting",
                    ),
                ),
                (
                    ...
                    ietf.utils.models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="name.ProceedingsMaterialTypeName",
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "logo",
                    ietf.utils.fields.MissingOkImageField(
        ...
        migrations.AddField(
            ...
            name="type",
            field=ietf.utils.models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="name.MeetingTypeName"
            ),
        ),
        migrations.CreateModel(
            name="ImportantDate",
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            (
                                "subsequent-days",
                                "Schedule the sessions on subsequent days",
                            ),
                            (
                                "one-day-seperation",
                ...
                (
                    ...
                    ietf.utils.models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="constraint_target_set",
                        to="group.Group",
                    ),
                ),
        ...
        migrations.AddIndex(
            model_name="timeslot",
            index=models.Index(
                fields=["-time", "-id"], name="meeting_tim_time_b802cb_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="meeting",
            index=models.Index(
                fields=["-date", "-id"], name="meeting_mee_date_40ca21_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="attended",
