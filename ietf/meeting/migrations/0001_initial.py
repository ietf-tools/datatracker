    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idsubmit_cutoff_time_utc', models.DurationField(blank=True, default=datetime.timedelta(0, 86399), help_text='The time of day (UTC) after which submission will be closed.  Use for example 23:59:59.')),
                ('idsubmit_cutoff_warning_days', models.DurationField(blank=True, default=datetime.timedelta(21), help_text="How long before the 00 cutoff to start showing cutoff warnings.  Use for example '21' or '21 days'.")),
