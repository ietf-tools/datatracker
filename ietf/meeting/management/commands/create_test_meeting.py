...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            ...
            dest="delete",
            action="store_true",
            help="Delete the test and development meeting",
        )
        parser.add_argument(
            "--old-conflicts",
            dest="old_conflicts",
    ...
    def _meeting_datetime(self, day, *time_args):
        ...
        return self.meeting_tz.localize(
            datetime.datetime.combine(self.start_date, datetime.time(*time_args))
            + datetime.timedelta(days=day)
        )

    def handle(self, *args, **options):
        if socket.gethostname().split(".")[0] in [
            "core3",
            "ietfa",
            "ietfb",
            "ietfc",
            ...
            raise EnvironmentError(
                "Refusing to create a test meetng on a production server"
            )
        ...
        if opt_delete:
            if Meeting.objects.filter(number="999").exists():
                ...
                self.stdout.write(
                    "Deleted test meeting IETF 999 and its related objects."
                )
            else:
                self.stderr.write(
                    "Test meeting IETF 999 does not exist; nothing to do.\n"
                )
        else:
            try:
                ...
                raise CommandError(
                    "{} is not a recognized time zone.".format(meeting_tzname)
                )

            if Meeting.objects.filter(number="999").exists():
                self.stderr.write(
                    "Test meeting IETF 999 already exists; nothing to do.\n"
                )
            else:
                ...
                if self.start_date.isoweekday() != 6:
                    self.stderr.write(
                        "Warning: test meeting does not start on Saturday, watch out for bugs"
                    )
                ...
                base_schedule = Schedule.objects.create(
                    meeting=m, name="base", owner_id=1, visible=True, public=True
                )
                ...
                r = Room.objects.create(
                    meeting=m,
                    name="Skai Suite 4 (Swissotel)",
                    capacity=None,
                    functional_name="Newcomers dinner",
                )
                r = Room.objects.create(
                    meeting=m, name="Ord", capacity=None, functional_name="Code Sprint"
                )
                r = Room.objects.create(
                    meeting=m,
                    name="Skai Suite 1 (Swissotel)",
                    capacity=None,
                    functional_name="Systers Networking",
                )
                r = Room.objects.create(
                    meeting=m,
                    name="Butterworth",
                    capacity=None,
                    functional_name="Attendee Sign-Up 2",
                )
                r = Room.objects.create(
                    meeting=m,
                    name="Bras Basah",
                    capacity=None,
                    functional_name="Attendee Sign-Up 1",
                )
                r = Room.objects.create(
                    meeting=m, name="Indiana", capacity=None, functional_name="NOC"
                )
                r = Room.objects.create(
                    meeting=m,
                    name="Ord/Blundell",
                    capacity=None,
                    functional_name="Terminal Room",
                )
                r = Room.objects.create(
                    meeting=m,
                    name="Bailey",
                    capacity=None,
                    functional_name="Secretariat",
                )
                r = Room.objects.create(
                    meeting=m,
                    name="Bonham",
                    capacity=None,
                    functional_name="NomCom Interviews",
                )
                r = Room.objects.create(
                    meeting=m, name="Fullerton", capacity=None, functional_name="NomCom"
                )
                r = Room.objects.create(
                    meeting=m, name="Minto", capacity=None, functional_name="LLC"
                )
                r = Room.objects.create(
                    meeting=m,
                    name="Mercury/Enterprise",
                    capacity=None,
                    functional_name="ISOC",
                )
                r = Room.objects.create(
                    meeting=m, name="Clark", capacity=None, functional_name="IESG"
                )
                r = Room.objects.create(
                    meeting=m, name="VIP B", capacity=None, functional_name="IAB"
                )
                r = Room.objects.create(
                    meeting=m,
                    name="Moor/Morrison",
                    capacity=None,
                    functional_name="Code Lounge",
                )
                r = Room.objects.create(
                    meeting=m,
                    name="Fairmont Ballroom Foyer",
                    capacity=None,
                    functional_name="Welcome Reception",
                )
                r = Room.objects.create(
                    meeting=m,
                    name="Convention Foyer",
                    capacity=None,
                    functional_name="IETF Registration",
                )
                r.session_types.set(TimeSlotTypeName.objects.filter(slug__in=["reg"]))
                r = Room.objects.create(
                    meeting=m,
                    name="Stamford & Fairmont Ballroom Foyers",
                    capacity=None,
                    functional_name="Breaks",
                )
                ...
                r = Room.objects.create(
                    ...
                    name="Canning/Padang",
                    capacity=None,
                    functional_name="Plenary",
                )
                r.session_types.set(
                    TimeSlotTypeName.objects.filter(slug__in=["plenary"])
                )
                r = Room.objects.create(
                    meeting=m,
                    name="Canning",
                    capacity=250,
                    functional_name="Breakout 8",
                )
                r.session_types.set(
                    TimeSlotTypeName.objects.filter(slug__in=["regular"])
                )
                r = Room.objects.create(
                    meeting=m, name="Padang", capacity=300, functional_name="Breakout 7"
                )
                r.session_types.set(
                    TimeSlotTypeName.objects.filter(slug__in=["regular"])
                )
                r = Room.objects.create(
                    ...
                    name="Collyer",
                    capacity=250,
                    functional_name="Breakout 6",
                )
                r.session_types.set(
                    TimeSlotTypeName.objects.filter(slug__in=["regular"])
                )
                r = Room.objects.create(
                    meeting=m, name="Sophia", capacity=200, functional_name="Breakout 5"
                )
                r.session_types.set(
                    TimeSlotTypeName.objects.filter(slug__in=["regular"])
                )
                r = Room.objects.create(
                    meeting=m, name="Olivia", capacity=150, functional_name="Breakout 4"
                )
                r.session_types.set(
                    TimeSlotTypeName.objects.filter(slug__in=["regular"])
                )
                r = Room.objects.create(
                    meeting=m, name="Hullet", capacity=100, functional_name="Breakout 3"
                )
                r.session_types.set(
                    TimeSlotTypeName.objects.filter(slug__in=["regular"])
                )
                r = Room.objects.create(
                    meeting=m, name="VIP A", capacity=100, functional_name="Breakout 2"
                )
                r.session_types.set(
                    TimeSlotTypeName.objects.filter(slug__in=["regular"])
                )
                r = Room.objects.create(
                    meeting=m, name="Orchard", capacity=50, functional_name="Breakout 1"
                )
                r.session_types.set(
                    TimeSlotTypeName.objects.filter(slug__in=["regular"])
                )
                ...
                s.resources.set(
                    ResourceAssociation.objects.filter(pk__in=[6])
                )  # [<ResourceAssociation: Experimental Room Setup (U-Shape and classroom, subject to availability)>]
                ## session for quic ##
                s = Session.objects.create(
                    meeting=m,
                    type_id="regular",
                ...
                c = Constraint.objects.create(
                    meeting=m, source=s.group, name_id="timerange"
                )
                c.timeranges.set(
                    TimerangeName.objects.exclude(slug__startswith="monday")
                    .exclude(slug__startswith="tuesday")
                    .exclude(slug__startswith="wednesday-morning")
                )
                c = Constraint.objects.create(
                    meeting=m,
                    source=s.group,
                ...
                c = Constraint.objects.create(
                    ...
                    source=s.group,
                    name_id="time_relation",
                    time_relation="one-day-seperation",
                )
                ...
                c.timeranges.set(
                    TimerangeName.objects.exclude(slug__startswith="friday").exclude(
                        slug__startswith="thursday"
                    )
                )
                ...
                c.timeranges.set(
                    TimerangeName.objects.filter(slug="thursday-afternoon-late")
                )
                ...
                c.timeranges.set(
                    TimerangeName.objects.exclude(slug__startswith="friday")
                )
                ...
                c.timeranges.set(
                    TimerangeName.objects.exclude(slug__startswith="monday").exclude(
                        slug__startswith="tuesday"
                    )
                )
                ...
                c.timeranges.set(
                    TimerangeName.objects.exclude(
                        slug__startswith="thursday-afternoon-early"
                    )
                )
                ...
                c.timeranges.set(
                    TimerangeName.objects.filter(slug__startswith="monday")
                )
                ...
                c.timeranges.set(
                    TimerangeName.objects.filter(slug__startswith="friday")
                )
                ...
                c.timeranges.set(
                    TimerangeName.objects.exclude(slug__startswith="monday")
                    .exclude(slug__startswith="tuesday")
                    .exclude(slug="wednesday-morning")
                )
                ...
                s.joint_with_groups.set(
                    Group.objects.filter(acronym__in=["i2nsf", "ipsecme", "bess"])
                )
                c = Constraint.objects.create(
                    meeting=m,
                    source=s.group,
                ...
                c = Constraint.objects.create(
                    meeting=m, source=s.group, name_id=conflict[1], target_id=1634
                )  # kitten
                c = Constraint.objects.create(
                    meeting=m, source=s.group, name_id=conflict[1], target_id=1674
                )  # emu
                c = Constraint.objects.create(
                    meeting=m, source=s.group, name_id=conflict[1], target_id=1740
                )  # ipsecme
                c = Constraint.objects.create(
                    meeting=m, source=s.group, name_id=conflict[1], target_id=1748
                )  # oauth
                c = Constraint.objects.create(
                    meeting=m, source=s.group, name_id=conflict[1], target_id=1869
                )  # sacm
                c = Constraint.objects.create(
                    meeting=m, source=s.group, name_id=conflict[1], target_id=1920
                )  # trans
                c = Constraint.objects.create(
                    meeting=m, source=s.group, name_id=conflict[1], target_id=1921
                )  # ace
                c = Constraint.objects.create(
                    meeting=m, source=s.group, name_id=conflict[1], target_id=1965
                )  # i2nsf
                c = Constraint.objects.create(
                    meeting=m, source=s.group, name_id=conflict[1], target_id=1990
                )  # tokbind
                c = Constraint.objects.create(
                    meeting=m, source=s.group, name_id=conflict[1], target_id=1995
                )  # acme
                c = Constraint.objects.create(
                    meeting=m, source=s.group, name_id=conflict[1], target_id=1996
                )  # dots
                c = Constraint.objects.create(
                    meeting=m, source=s.group, name_id=conflict[1], target_id=2002
                )  # cose
                c = Constraint.objects.create(
                    meeting=m, source=s.group, name_id=conflict[1], target_id=2143
                )  # curdle
                c = Constraint.objects.create(
                    meeting=m, source=s.group, name_id=conflict[1], target_id=2169
                )  # secevent
                c = Constraint.objects.create(
                    meeting=m, source=s.group, name_id=conflict[1], target_id=2194
                )  # teep
                c = Constraint.objects.create(
                    meeting=m, source=s.group, name_id=conflict[1], target_id=2231
                )  # rats
                c = Constraint.objects.create(
                    meeting=m, source=s.group, name_id=conflict[1], target_id=2249
                )  # lake
                ...
                c.timeranges.set(
                    TimerangeName.objects.filter(
                        Q(slug__startswith="friday") | Q(slug="tuesday-morning")
                    )
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(6, 12, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Orchard"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(6, 12, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="VIP A"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(6, 12, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Hullet"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(6, 12, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Olivia"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(6, 12, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Sophia"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(6, 12, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Collyer"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(6, 12, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Padang"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(6, 12, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Canning"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(6, 12, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Canning/Padang"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(6, 12, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(
                        meeting=m, name="Stamford & Fairmont Ballroom Foyers"
                    ),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(6, 12, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Convention Foyer"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(
                        meeting=m, name="Fairmont Ballroom Foyer"
                    ),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(6, 12, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Moor/Morrison"),
                    show_location=True,
                )
                ## timeslot 2019-11-22 12:20:00 length 1:30:00 in Moor/Morrison size: None ##
                TimeSlot.objects.create(
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(6, 12, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="VIP B"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(6, 12, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Clark"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(6, 12, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Mercury/Enterprise"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(6, 12, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Minto"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(6, 12, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Fullerton"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(6, 12, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Bonham"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(6, 12, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Bailey"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(6, 12, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Ord/Blundell"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(6, 12, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Indiana"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(6, 12, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Bras Basah"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(6, 12, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Butterworth"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(6, 12, 0),
                    duration=datetime.timedelta(seconds=1200),
                    location=Room.objects.get(
                        meeting=m, name="Stamford & Fairmont Ballroom Foyers"
                    ),
                    show_location=True,
                ...
                TimeSlot.objects.create(
                    meeting=m,
                    type_id="regular",
                    name="Morning Session I",
                    time=self._meeting_datetime(6, 10, 0),
                ...
                TimeSlot.objects.create(
                    meeting=m,
                    type_id="other",
                    name="Side Meetings / Open Time",
                    time=self._meeting_datetime(6, 8, 30),
                    duration=datetime.timedelta(seconds=4500),
                    location=None,
                    show_location=False,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="break",
                    name="Beverage Break",
                    time=self._meeting_datetime(6, 8, 0),
                ...
                TimeSlot.objects.create(
                    meeting=m,
                    type_id="regular",
                    name="Afternoon Session III",
                    time=self._meeting_datetime(5, 17, 40),
                    duration=datetime.timedelta(seconds=3600),
                    location=Room.objects.get(meeting=m, name="Orchard"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="break",
                    name="Beverage Break",
                    time=self._meeting_datetime(5, 17, 20),
                    duration=datetime.timedelta(seconds=1200),
                    location=Room.objects.get(
                        meeting=m, name="Stamford & Fairmont Ballroom Foyers"
                    ),
                ...
                TimeSlot.objects.create(
                    meeting=m,
                    type_id="regular",
                    name="Afternoon Session II",
                    time=self._meeting_datetime(5, 15, 50),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Orchard"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="break",
                    name="Beverage and Snack Break",
                    time=self._meeting_datetime(5, 15, 30),
                    duration=datetime.timedelta(seconds=1200),
                    location=Room.objects.get(
                        meeting=m, name="Stamford & Fairmont Ballroom Foyers"
                    ),
                ...
                TimeSlot.objects.create(
                    meeting=m,
                    type_id="regular",
                    name="Afternoon Session I",
                    time=self._meeting_datetime(5, 13, 30),
                    duration=datetime.timedelta(seconds=7200),
                    location=Room.objects.get(meeting=m, name="Orchard"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(5, 12, 30),
                    duration=datetime.timedelta(seconds=2700),
                    location=Room.objects.get(meeting=m, name="Collyer"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="other",
                    name="Systers Lunch",
                    time=self._meeting_datetime(5, 12, 15),
                    duration=datetime.timedelta(seconds=3600),
                    location=Room.objects.get(
                        meeting=m, name="Skai Suite 1 (Swissotel)"
                    ),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="break",
                    name="Break",
                    time=self._meeting_datetime(5, 12, 0),
                    duration=datetime.timedelta(seconds=5400),
                    location=None,
                    show_location=False,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="regular",
                    name="Morning Session I",
                    time=self._meeting_datetime(5, 10, 0),
                    duration=datetime.timedelta(seconds=7200),
                    location=Room.objects.get(meeting=m, name="Orchard"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    meeting=m,
                    type_id="other",
                    name="NomCom Office Hours",
                    time=self._meeting_datetime(5, 9, 0),
                    duration=datetime.timedelta(seconds=3600),
                    location=Room.objects.get(meeting=m, name="Fullerton"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="other",
                    name="Side Meetings / Open Time",
                    time=self._meeting_datetime(5, 8, 30),
                    duration=datetime.timedelta(seconds=4500),
                    location=None,
                    show_location=False,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    name="IETF Registration",
                    time=self._meeting_datetime(5, 8, 30),
                    duration=datetime.timedelta(seconds=34200),
                    location=Room.objects.get(meeting=m, name="Convention Foyer"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    meeting=m,
                    type_id="other",
                    name="Newcomers' Feedback Session",
                    time=self._meeting_datetime(5, 8, 0),
                    duration=datetime.timedelta(seconds=3600),
                    location=Room.objects.get(meeting=m, name="Bras Basah"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="plenary",
                    name="IETF Plenary",
                    time=self._meeting_datetime(4, 17, 10),
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="break",
                    name="Beverage and Snack Break",
                    time=self._meeting_datetime(4, 16, 50),
                    duration=datetime.timedelta(seconds=1200),
                    location=Room.objects.get(
                        meeting=m, name="Stamford & Fairmont Ballroom Foyers"
                    ),
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="regular",
                    name="Afternoon Session II",
                    time=self._meeting_datetime(4, 15, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Orchard"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="break",
                    name="Beverage Break",
                    time=self._meeting_datetime(4, 15, 0),
                    duration=datetime.timedelta(seconds=1200),
                    location=Room.objects.get(
                        meeting=m, name="Stamford & Fairmont Ballroom Foyers"
                    ),
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="regular",
                    name="Afternoon Session I",
                    time=self._meeting_datetime(4, 13, 30),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Orchard"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    meeting=m,
                    type_id="other",
                    name="WG Chairs Forum (For WG Chairs Only)",
                    time=self._meeting_datetime(4, 12, 15),
                    duration=datetime.timedelta(seconds=3600),
                    location=Room.objects.get(meeting=m, name="Sophia"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="break",
                    name="Break",
                    time=self._meeting_datetime(4, 12, 0),
                    duration=datetime.timedelta(seconds=5400),
                    location=None,
                    show_location=False,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="regular",
                    name="Morning Session I",
                    time=self._meeting_datetime(4, 10, 0),
                    duration=datetime.timedelta(seconds=7200),
                    location=Room.objects.get(meeting=m, name="Orchard"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="other",
                    name="NomCom Office Hours",
                    time=self._meeting_datetime(4, 9, 0),
                    duration=datetime.timedelta(seconds=3600),
                    location=Room.objects.get(meeting=m, name="Fullerton"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="other",
                    name="Side Meetings / Open Time",
                    time=self._meeting_datetime(4, 8, 30),
                    duration=datetime.timedelta(seconds=4500),
                    location=None,
                    show_location=False,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    name="IETF Registration",
                    time=self._meeting_datetime(4, 8, 30),
                    duration=datetime.timedelta(seconds=31200),
                    location=Room.objects.get(meeting=m, name="Convention Foyer"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="break",
                    name="Beverage Break",
                    time=self._meeting_datetime(4, 8, 0),
                    duration=datetime.timedelta(seconds=3600),
                    location=Room.objects.get(
                        meeting=m, name="Stamford & Fairmont Ballroom Foyers"
                    ),
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="lead",
                    name="IAB Breakfast",
                    time=self._meeting_datetime(4, 7, 30),
                    duration=datetime.timedelta(seconds=7200),
                    location=None,
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    meeting=m,
                    type_id="other",
                    name="IETF 106 Social Event at the ArtScience Museum Marina Bay Sands - Hosted by Nokia",
                    time=self._meeting_datetime(3, 19, 0),
                    duration=datetime.timedelta(seconds=14400),
                    location=None,
                    show_location=False,
                )
                ...
                TimeSlot.objects.create(
                    meeting=m,
                    type_id="other",
                    name="Internet Area AD Office Hours",
                    time=self._meeting_datetime(3, 17, 10),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Clark"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="break",
                    name="Beverage Break",
                    time=self._meeting_datetime(3, 16, 50),
                    duration=datetime.timedelta(seconds=1200),
                    location=Room.objects.get(
                        meeting=m, name="Stamford & Fairmont Ballroom Foyers"
                    ),
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="regular",
                    name="Afternoon Session II",
                    time=self._meeting_datetime(3, 15, 20),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Orchard"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="break",
                    name="Beverage and Snack Break",
                    time=self._meeting_datetime(3, 15, 0),
                    duration=datetime.timedelta(seconds=1200),
                    location=Room.objects.get(
                        meeting=m, name="Stamford & Fairmont Ballroom Foyers"
                    ),
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="regular",
                    name="Afternoon Session I",
                    time=self._meeting_datetime(3, 13, 30),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Orchard"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="break",
                    name="Break",
                    time=self._meeting_datetime(3, 12, 0),
                    duration=datetime.timedelta(seconds=5400),
                    location=None,
                    show_location=False,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="regular",
                    name="Morning Session I",
                    time=self._meeting_datetime(3, 10, 0),
                    duration=datetime.timedelta(seconds=7200),
                    location=Room.objects.get(meeting=m, name="Orchard"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="other",
                    name="NomCom Office Hours",
                    time=self._meeting_datetime(3, 9, 0),
                    duration=datetime.timedelta(seconds=3600),
                    location=Room.objects.get(meeting=m, name="Fullerton"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="other",
                    name="Side Meetings / Open Time",
                    time=self._meeting_datetime(3, 8, 30),
                    duration=datetime.timedelta(seconds=4500),
                    location=None,
                    show_location=False,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    name="IETF Registration",
                    time=self._meeting_datetime(3, 8, 30),
                    duration=datetime.timedelta(seconds=36000),
                    location=Room.objects.get(meeting=m, name="Convention Foyer"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="break",
                    name="Beverage Break",
                    time=self._meeting_datetime(3, 8, 0),
                    duration=datetime.timedelta(seconds=3600),
                    location=Room.objects.get(
                        meeting=m, name="Stamford & Fairmont Ballroom Foyers"
                    ),
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="lead",
                    name="IAB Breakfast",
                    time=self._meeting_datetime(3, 7, 30),
                    duration=datetime.timedelta(seconds=7200),
                    location=None,
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    meeting=m,
                    type_id="other",
                    name="Newcomers' Dinner (Open to Newcomers. Note that pre-registration is required and a $25USD fee will be charged.)",
                    time=self._meeting_datetime(2, 19, 30),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(
                        meeting=m, name="Skai Suite 4 (Swissotel)"
                    ),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    meeting=m,
                    type_id="other",
                    name="Hackdemo Happy Hour",
                    time=self._meeting_datetime(2, 18, 10),
                    duration=datetime.timedelta(seconds=5400),
                    location=Room.objects.get(meeting=m, name="Moor/Morrison"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="break",
                    name="Beverage Break",
                    time=self._meeting_datetime(2, 17, 50),
                    duration=datetime.timedelta(seconds=1200),
                    location=Room.objects.get(
                        meeting=m, name="Stamford & Fairmont Ballroom Foyers"
                    ),
                ...
                TimeSlot.objects.create(
                    meeting=m,
                    type_id="other",
                    name="TSV AD Office Hours",
                    time=self._meeting_datetime(2, 16, 50),
                    duration=datetime.timedelta(seconds=3600),
                    location=Room.objects.get(meeting=m, name="Clark"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="regular",
                    name="Afternoon Session II",
                    time=self._meeting_datetime(2, 15, 50),
                    duration=datetime.timedelta(seconds=7200),
                    location=Room.objects.get(meeting=m, name="Orchard"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="break",
                    name="Beverage and Snack Break",
                    time=self._meeting_datetime(2, 15, 30),
                    duration=datetime.timedelta(seconds=1200),
                    location=Room.objects.get(
                        meeting=m, name="Stamford & Fairmont Ballroom Foyers"
                    ),
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="regular",
                    name="Afternoon Session I",
                    time=self._meeting_datetime(2, 13, 30),
                    duration=datetime.timedelta(seconds=7200),
                    location=Room.objects.get(meeting=m, name="Orchard"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="break",
                    name="Break",
                    time=self._meeting_datetime(2, 12, 0),
                    duration=datetime.timedelta(seconds=5400),
                    location=None,
                    show_location=False,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="regular",
                    name="Morning Session I",
                    time=self._meeting_datetime(2, 10, 0),
                    duration=datetime.timedelta(seconds=7200),
                    location=Room.objects.get(meeting=m, name="Orchard"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="other",
                    name="NomCom Office Hours",
                    time=self._meeting_datetime(2, 9, 0),
                    duration=datetime.timedelta(seconds=3600),
                    location=Room.objects.get(meeting=m, name="Fullerton"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="other",
                    name="Side Meetings / Open Time",
                    time=self._meeting_datetime(2, 8, 30),
                    duration=datetime.timedelta(seconds=4500),
                    location=None,
                    show_location=False,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="break",
                    name="Beverage Break",
                    time=self._meeting_datetime(2, 8, 0),
                    duration=datetime.timedelta(seconds=3600),
                    location=Room.objects.get(
                        meeting=m, name="Stamford & Fairmont Ballroom Foyers"
                    ),
                ...
                TimeSlot.objects.create(
                    meeting=m,
                    type_id="regular",
                    name="Hot RFC Lightning Talks",
                    time=self._meeting_datetime(1, 18, 0),
                    duration=datetime.timedelta(seconds=7200),
                    location=Room.objects.get(meeting=m, name="Orchard"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    time=self._meeting_datetime(1, 17, 0),
                    duration=datetime.timedelta(seconds=7200),
                    location=Room.objects.get(
                        meeting=m, name="Fairmont Ballroom Foyer"
                    ),
                ...
                TimeSlot.objects.create(
                    meeting=m,
                    type_id="other",
                    name="Newcomers' Quick Connections (Open to Newcomers. Note that pre-registration is required)",
                    time=self._meeting_datetime(1, 16, 0),
                    duration=datetime.timedelta(seconds=3600),
                    location=Room.objects.get(
                        meeting=m, name="Fairmont Ballroom Foyer"
                    ),
                ...
                TimeSlot.objects.create(
                    meeting=m,
                    type_id="other",
                    name="Tutorial: Service Discovery for IP Applications",
                    time=self._meeting_datetime(1, 13, 45),
                    duration=datetime.timedelta(seconds=3600),
                    location=Room.objects.get(meeting=m, name="Sophia"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    meeting=m,
                    type_id="other",
                    name="Tutorial: Newcomers' Overview",
                    time=self._meeting_datetime(1, 12, 30),
                    duration=datetime.timedelta(seconds=3600),
                    location=Room.objects.get(meeting=m, name="Olivia"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="other",
                    name="IEPG Meeting",
                    time=self._meeting_datetime(1, 10, 0),
                    duration=datetime.timedelta(seconds=7200),
                    location=Room.objects.get(meeting=m, name="Olivia"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="other",
                    name="IETF Hackathon",
                    time=self._meeting_datetime(1, 8, 30),
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="other",
                    name="Code Sprint",
                    time=self._meeting_datetime(0, 9, 30),
                    duration=datetime.timedelta(seconds=30600),
                    location=Room.objects.get(meeting=m, name="Ord"),
                    show_location=True,
                )
                ...
                TimeSlot.objects.create(
                    ...
                    type_id="other",
                    name="IETF Hackathon",
                    time=self._meeting_datetime(0, 8, 30),
                    duration=datetime.timedelta(seconds=48600),
                    location=Room.objects.get(meeting=m, name="Moor/Morrison"),
                    show_location=True,
                )
                ...
                for s in m.session_set.all():
                    SchedulingEvent.objects.create(
                        session=s, status_id="schedw", by_id=1
                    )
