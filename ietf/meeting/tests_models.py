...
class MeetingTests(TestCase):
    def test_get_attendance_pre110(self):
        ...
        MeetingRegistrationFactory.create_batch(
            5, meeting=meeting, reg_type="in_person"
        )
    ...
    def test_get_attendance_110(self):
        ...
        MeetingRegistrationFactory.create_batch(
            3, meeting=meeting, reg_type="", attended=True
        )
        ...
        MeetingRegistrationFactory.create_batch(
            4, meeting=meeting, reg_type="remote", attended=True
        )
        ...
        MeetingRegistrationFactory.create_batch(
            5, meeting=meeting, reg_type="onsite", attended=True
        )
        MeetingRegistrationFactory(
            meeting=meeting, reg_type="in_person", attended=False
        )
        attendance = meeting.get_attendance()
        self.assertIsNotNone(attendance)
        self.assertEqual(attendance.remote, 4)
    ...
    def test_get_attendance_113(self):
        ...
        MeetingRegistrationFactory(
            meeting=meeting, reg_type="onsite", attended=True, checkedin=False
        )
        MeetingRegistrationFactory(
            meeting=meeting, reg_type="onsite", attended=False, checkedin=True
        )
        p1 = MeetingRegistrationFactory(
            meeting=meeting, reg_type="onsite", attended=False, checkedin=False
        ).person
        AttendedFactory(session__meeting=meeting, person=p1)
        p2 = MeetingRegistrationFactory(
            meeting=meeting, reg_type="remote", attended=False, checkedin=False
        ).person
    ...
    def test_get_attendance_keeps_meetings_distinct(self):
        ...
        p = MeetingRegistrationFactory(
            meeting=second_mtg, reg_type="onsite", attended=False, checkedin=False
        ).person
