...
urlpatterns = [
    ...
    url(
        r"^help/fields/$",
        TemplateView.as_view(template_name="liaisons/field_help.html"),
        name="liaison-help-fields",
    ),
    url(
        r"^help/from_ietf/$",
        TemplateView.as_view(template_name="liaisons/guide_from_ietf.html"),
    ),
    url(
        r"^help/to_ietf/$",
        TemplateView.as_view(template_name="liaisons/guide_to_ietf.html"),
    ),
    url(
        r"^managers/$",
        RedirectView.as_view(
            url="https://www.ietf.org/liaison/managers.html", permanent=True
        ),
    ),
]
...
urlpatterns += [
    ...
    url(
        r"^(?P<object_id>\d+)/edit-attachment/(?P<doc_id>[A-Za-z0-9._+-]+)$",
        views.liaison_edit_attachment,
    ),
    url(
        r"^(?P<object_id>\d+)/delete-attachment/(?P<attach_id>[A-Za-z0-9._+-]+)$",
        views.liaison_delete_attachment,
    ),
