...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LiaisonDetail.taken_care'
        db.add_column('liaison_detail', 'taken_care', orm['liaisons.liaisondetail:taken_care'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'LiaisonDetail.taken_care'
        db.delete_column('liaison_detail', 'taken_care')
