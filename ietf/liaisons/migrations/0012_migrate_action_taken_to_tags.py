...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        action_needed = orm['name.LiaisonStatementTagName'].objects.get(slug='required')
        action_taken = orm['name.LiaisonStatementTagName'].objects.get(slug='taken')

        for liaison in orm['liaisons.LiaisonStatement'].objects.all():
            if liaison.action_taken:
                liaison.tags.add(action_taken)
            elif liaison.deadline:
                liaison.tags.add(action_needed)
