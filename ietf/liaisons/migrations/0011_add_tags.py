...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field tags on 'LiaisonStatement'
        m2m_table_name = db.shorten_name(u'liaisons_liaisonstatement_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('liaisonstatement', models.ForeignKey(orm[u'liaisons.liaisonstatement'], null=False)),
            ('liaisonstatementtagname', models.ForeignKey(orm[u'name.liaisonstatementtagname'], null=False))
        ))
        db.create_unique(m2m_table_name, ['liaisonstatement_id', 'liaisonstatementtagname_id'])

    def backwards(self, orm):
        # Removing M2M table for field tags on 'LiaisonStatement'
        db.delete_table(db.shorten_name(u'liaisons_liaisonstatement_tags'))
