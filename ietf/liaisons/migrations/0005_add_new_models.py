...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LiaisonStatementEvent'
        db.create_table(u'liaisons_liaisonstatementevent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['name.LiaisonStatementEventTypeName'])),
            ('by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['person.Person'])),
            ('statement', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['liaisons.LiaisonStatement'])),
            ('desc', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'liaisons', ['LiaisonStatementEvent'])

        # Adding model 'LiaisonStatementGroupContacts'
        db.create_table(u'liaisons_liaisonstatementgroupcontacts', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['group.Group'], unique=True)),
            ('default_reply_to', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'liaisons', ['LiaisonStatementGroupContacts'])

        # Adding model 'RelatedLiaisonStatement'
        db.create_table(u'liaisons_relatedliaisonstatement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='source_of_set', to=orm['liaisons.LiaisonStatement'])),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(related_name='target_of_set', to=orm['liaisons.LiaisonStatement'])),
            ('relationship', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['name.DocRelationshipName'])),
        ))
        db.send_create_signal(u'liaisons', ['RelatedLiaisonStatement'])

    def backwards(self, orm):
        # Deleting model 'LiaisonStatementEvent'
        db.delete_table(u'liaisons_liaisonstatementevent')

        # Deleting model 'LiaisonStatementGroupContacts'
        db.delete_table(u'liaisons_liaisonstatementgroupcontacts')

        # Deleting model 'RelatedLiaisonStatement'
        db.delete_table(u'liaisons_relatedliaisonstatement')
