...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LiaisonStatement.other_identifiers'
        db.add_column(u'liaisons_liaisonstatement', 'other_identifiers',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field from_groups on 'LiaisonStatement'
        m2m_table_name = db.shorten_name(u'liaisons_liaisonstatement_from_groups')
        ...
        # Adding M2M table for field to_groups on 'LiaisonStatement'
        m2m_table_name = db.shorten_name(u'liaisons_liaisonstatement_to_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('liaisonstatement', models.ForeignKey(orm[u'liaisons.liaisonstatement'], null=False)),
            ('group', models.ForeignKey(orm[u'group.group'], null=False))
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field from_groups on 'LiaisonStatement'
        db.delete_table(db.shorten_name(u'liaisons_liaisonstatement_from_groups'))
