...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LiaisonDetail.from_raw_body'
        db.add_column('liaison_detail', 'from_raw_body', orm['liaisons.liaisondetail:from_raw_body'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'LiaisonDetail.from_raw_body'
        db.delete_column('liaison_detail', 'from_raw_body')
