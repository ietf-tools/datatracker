...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'liaisons_liaisonstatement_attachments', u'liaisonstatement_id', u'statement_id')
        db.add_column(u'liaisons_liaisonstatement_attachments', 'removed',
                      self.gf('django.db.models.fields.BooleanField')(default=False))
        db.rename_table(u'liaisons_liaisonstatement_attachments', u'liaisons_liaisonstatementattachments')

    def backwards(self, orm):
        db.rename_table(u'liaisons_liaisonstatementattachments', u'liaisons_liaisonstatement_attachments')
        db.delete_column(u'liaisons_liaisonstatement_attachments', 'removed')
        db.rename_column(u'liaisons_liaisonstatement_attachments', u'statement_id', u'liaisonstatement_id')
