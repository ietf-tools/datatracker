...
urlpatterns = [
    url(
        r"^help/(?:sub)?state/(?:\d+/)?$",
        RedirectView.as_view(url="/doc/help/state/draft-iesg/", permanent=True),
    ),
    url(
        r"^help/evaluation/$",
        RedirectView.as_view(
            url="https://www.ietf.org/iesg/voting-procedures.html", permanent=True
        ),
    ),
