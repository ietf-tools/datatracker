...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ConsensusDocEvent.consensus'
        db.alter_column(u'doc_consensusdocevent', 'consensus', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'ConsensusDocEvent.consensus'
        db.alter_column(u'doc_consensusdocevent', 'consensus', self.gf('django.db.models.fields.BooleanField')())
