...
class Migration(DataMigration):
    ...
    def add_state_change_event(self, orm, doc, by, new_state, timestamp):
        e = orm.StateDocEvent(doc=doc, by=by)
        e.type = "changed_state"
        e.state_type = new_state.type
        e.state = new_state
    ...
    def forwards(self, orm):
        ...
        missing_states=[orm.State.objects.get(type='draft-iesg',slug='pub-req'), 
                        orm.State.objects.get(type='draft-stream-ietf',slug='sub-pub'),
                       ]
