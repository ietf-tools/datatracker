...
class SearchTests(TestCase):
    ...
    def test_docs_for_ad(self):
        ...
        dead_draft = IndividualDraftFactory(ad=ad)
        dead_draft.set_state(State.objects.get(type='draft-iesg', slug='dead'))
        idexists_draft = IndividualDraftFactory(ad=ad)
        idexists_draft.set_state(State.objects.get(type='draft-iesg', slug='idexists'))
        ...
        self.assertNotContains(r, dead_draft.name)
        self.assertNotContains(r, idexists_draft.name)
