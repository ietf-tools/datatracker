    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "compliant",
                    models.BooleanField(
                        default=True, verbose_name="Complies to RFC3979"
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        max_length=255,
                        verbose_name="Designations for other contributions",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "holder_contact_info",
                    models.TextField(blank=True, help_text="Address, phone, etc."),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    ietf.utils.models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="relatedipr_source_set",
                        to="ipr.IprDisclosureBase",
                    ),
                ),
                (
                    ...
                    ietf.utils.models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="relatedipr_target_set",
                        to="ipr.IprDisclosureBase",
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through="ipr.RelatedIpr", to="ipr.IprDisclosureBase"
            ),
        ),
        migrations.AddField(
            model_name="iprdisclosurebase",
            ...
            field=ietf.utils.models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to="name.IprDisclosureStateName",
            ),
        ),
        migrations.AddIndex(
            model_name="iprevent",
            index=models.Index(
                fields=["-time", "-id"], name="ipr_ipreven_time_9630c4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="iprdisclosurebase",
            index=models.Index(
                fields=["-time", "-id"], name="ipr_iprdisc_time_846a78_idx"
            ),
        ),
        migrations.AddField(
