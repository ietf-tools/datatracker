    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "content_type",
                    models.CharField(blank=True, default="text/plain", max_length=255),
                ),
                (
                    "msgid",
                    ietf.message.models.HeaderField(
                        blank=True, default=email.utils.make_msgid, null=True
                    ),
                ),
                ...
                (
                    "related_groups",
                    models.ManyToManyField(blank=True, to="group.Group"),
                ),
            ],
            options={
                "ordering": ["time"],
