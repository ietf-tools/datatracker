                            ...
                            if unique:
                                ...
                                try:
                                    ...
                                    self.stderr.write(
                                        ...
                                        "  New record: %s\n"
                                        "  Exception: %s"
                                        % (mname, this_pk, unique, new_dict, e)
                                    )
                            else:
                                        ...
                                        if m2mfield.through:
                                            ...
                                            for ff in through._meta.fields:
                                                if type(ff) == ForeignKey:
                                                    ...
                                                    if (
                                                        ff.related_model == model
                                                        and old_value == old_pk
                                                    ):
                                                        setattr(
                                                            through,
                                                            ff.name + "_id",
    ...
    def find_fixtures(self, fixture_label):
        ...
        if os.path.exists(fixture_label):
            fixture_files = [
                (
                    fixture_label,
                    os.path.dirname(fixture_label) or os.getcwd(),
                    os.path.basename(fixture_label),
                )
            ]
        else:
