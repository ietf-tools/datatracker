...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "access_key",
                    models.CharField(
                        default=ietf.utils.accesstoken.generate_random_key,
                        max_length=255,
                    ),
                ),
                ...
                (
                    "submission_date",
                    models.DateField(default=ietf.utils.timezone.date_today),
                ),
                (
                    "xml_version",
                ...
                (
                    ...
                    ietf.utils.models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="name.DraftSubmissionStateName",
                    ),
                ),
            ],
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["-time", "-id"], name="submit_subm_time_fcd790_idx"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["submission_date"], name="submit_subm_submiss_8e58a9_idx"
            ),
        ),
    ]
