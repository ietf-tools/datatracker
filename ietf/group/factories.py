...
class GroupHistoryFactory(factory.django.DjangoModelFactory):
    ...
    uses_milestone_dates = factory.LazyAttribute(
        lambda obj: obj.group.uses_milestone_dates
    )
    ...
    list_email = factory.LazyAttribute(
        lambda obj: "%s@ietf.org" % obj.group.acronym
    )  # TODO : move this to GroupFactory
    ...
    meeting_seen_as_area = factory.LazyAttribute(
        lambda obj: obj.group.meeting_seen_as_area
    )
...
class AppealArtifactFactory(factory.django.DjangoModelFactory):
    ...
    artifact_type = factory.SubFactory(
        "ietf.name.factories.AppealArtifactTypeNameFactory", slug="appeal"
    )
