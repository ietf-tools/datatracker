...
info_detail_urls = [
    ...
    url(
        r"^milestones/$",
        milestone_views.edit_milestones,
        {"milestone_set": "current"},
        name="ietf.group.milestones.edit_milestones;current",
    ),
    url(
        r"^milestones/charter/$",
        milestone_views.edit_milestones,
        {"milestone_set": "charter"},
        name="ietf.group.milestones.edit_milestones;charter",
    ),
    url(
        r"^milestones/charter/reset/$",
        milestone_views.reset_charter_milestones,
        None,
    ...
    url(
        r"^materials/new/(?P<doc_type>[\w-]+)/$",
        material_views.edit_material,
        {"action": "new"},
...
grouptype_urls = [
    ...
    url(
        r"^summary-by-area.txt",
        RedirectView.as_view(url="/wg/1wg-summary.txt", permanent=True),
    ),
    url(
        r"^summary-by-acronym.txt",
        RedirectView.as_view(url="/wg/1wg-summary-by-acronym.txt", permanent=True),
    ),
    ...
    url(
        ...
        RedirectView.as_view(
            url="/group/chartering/create/%(group_type)s/", permanent=True
        ),
    ),
