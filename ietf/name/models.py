...
class SessionPurposeName(NameModel):
    ...
    on_agenda = models.BooleanField(
        default=True,
        help_text="Are sessions of this purpose visible on the agenda by default?",
    )
...
class ConstraintName(NameModel):
    ...
    is_group_conflict = models.BooleanField(
        default=False,
...
class DraftSubmissionStateName(NameModel):
    ...
    next_states = models.ManyToManyField(
        "name.DraftSubmissionStateName", related_name="previous_states", blank=True
    )
