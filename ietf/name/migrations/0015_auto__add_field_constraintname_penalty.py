...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ConstraintName.penalty'
        db.add_column('name_constraintname', 'penalty', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ConstraintName.penalty'
        db.delete_column('name_constraintname', 'penalty')
