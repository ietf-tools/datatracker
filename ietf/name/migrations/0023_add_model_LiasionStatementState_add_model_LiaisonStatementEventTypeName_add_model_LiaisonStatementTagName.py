...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LiaisonStatementState'
        db.create_table(u'name_liaisonstatementstate', (
        ...
        db.send_create_signal(u'name', ['LiaisonStatementState'])

        # Adding model 'LiaisonStatementEventTypeName'
        db.create_table(u'name_liaisonstatementeventtypename', (
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=8, primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('desc', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('used', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ...
        db.send_create_signal(u'name', ['LiaisonStatementEventTypeName'])

        # Adding model 'LiaisonStatementTagName'
        db.create_table(u'name_liaisonstatementtagname', (
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=8, primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('desc', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('used', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ...
        db.send_create_signal(u'name', ['LiaisonStatementTagName'])


    def backwards(self, orm):
        # Deleting model 'LiaisonStatementState'
        db.delete_table(u'name_liaisonstatementstate')

        # Deleting model 'LiaisonStatementEventTypeName'
        db.delete_table(u'name_liaisonstatementeventtypename')

        # Deleting model 'LiaisonStatementTagName'
        db.delete_table(u'name_liaisonstatementtagname')
