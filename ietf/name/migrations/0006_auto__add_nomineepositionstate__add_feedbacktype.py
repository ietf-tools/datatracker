...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NomineePositionState'
        db.create_table('name_nomineepositionstate', (
        ...
        db.send_create_signal('name', ['NomineePositionState'])

        # Adding model 'FeedbackType'
        db.create_table('name_feedbacktype', (
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=8, primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('desc', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('used', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ...
        db.send_create_signal('name', ['FeedbackType'])

    def backwards(self, orm):

        # Deleting model 'NomineePositionState'
        db.delete_table('name_nomineepositionstate')

        # Deleting model 'FeedbackType'
        db.delete_table('name_feedbacktype')
