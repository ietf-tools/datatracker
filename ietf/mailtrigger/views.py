...
def show_triggers(request, mailtrigger_slug=None):
    ...
    return render(
        request,
        "mailtrigger/trigger.html",
        {"mailtrigger_slug": mailtrigger_slug, "mailtriggers": mailtriggers},
    )
...
def show_recipients(request, recipient_slug=None):
    ...
    return render(
        request,
        "mailtrigger/recipient.html",
        {"recipient_slug": recipient_slug, "recipients": recipients},
    )
