...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Position.incumbent'
        db.alter_column('nomcom_position', 'incumbent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['person.Email'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Position.incumbent'
        raise RuntimeError("Cannot reverse this migration. 'Position.incumbent' and its values cannot be restored.")
    ...
    models = {
        ...
        'nomcom.position': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'incumbent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['person.Email']", 'null': 'True', 'blank': 'True'}),
