...
def forward(apps, schema_editor):
    ...
    MeetingRegistration.objects.filter(meeting__number__lte=106, reg_type="").update(
        reg_type="onsite", checkedin=True
    )
...
def reverse(apps, schema_editor):
    ...
    MeetingRegistration.objects.filter(
        meeting__number__lte=106, reg_type="onsite"
    ).update(reg_type="", checkedin=False)
