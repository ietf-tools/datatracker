...
urlpatterns = [
    ...
    url(r"^authors/(?P<doc_type>draft|rfc|all)/(?P<stats_type>affiliation|country)/$", views.authors_timeline),
    url(r"^document/(?P<doc_type>draft|rfc|all)/(?P<stats_type>type|stream)/$", views.documents_timeline),
