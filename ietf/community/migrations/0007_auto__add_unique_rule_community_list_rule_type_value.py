...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Rule', fields ['community_list', 'rule_type', 'value']
        db.create_unique('community_rule', ['community_list_id', 'rule_type', 'value'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Rule', fields ['community_list', 'rule_type', 'value']
        db.delete_unique('community_rule', ['community_list_id', 'rule_type', 'value'])
    ...
    models = {
        ...
        'community.communitylist': {
            ...
            'added_ids': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['doc.Document']", 'symmetrical': 'False'}),
        ...
        'community.rule': {
            'Meta': {'unique_together': "(('community_list', 'rule_type', 'value'),)", 'object_name': 'Rule'},
            'cached_ids': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['doc.Document']", 'symmetrical': 'False'}),
            'community_list': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['community.CommunityList']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
